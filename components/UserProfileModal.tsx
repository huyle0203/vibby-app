      ...
      showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.actionIcons}>
          <View style={styles.iconContainer}>
            <TouchableOpacity>
              <Iconify icon="lucide:share" size={24} color="#fff" />
            </TouchableOpacity>
            <Text style={styles.iconText}>Share</Text>
          </View>
          <View style={styles.iconContainer}>
            <TouchableOpacity>
              <Iconify icon="lucide:message-circle" size={24} color="#fff" />
            </TouchableOpacity>
            <Text style={styles.iconText}>Message</Text>
          </View>
          <View style={styles.iconContainer}>
            <TouchableOpacity>
              <Iconify icon="tabler:heart-bolt" size={24} color="#fff" />
            </TouchableOpacity>
            <Text style={styles.iconText}>Vibe</Text>
          </View>
        </View>
