...
const avatars: Avatar[] = [
  {
    source: require("../assets/images/profile_vibbyBlue.png"),
    value: "profile_vibbyBlue",
  },
  {
    source: require("../assets/images/profile_vibbyPink.png"),
    value: "profile_vibbyPink",
  },
  {
    source: require("../assets/images/profile_vibbyRed.png"),
    value: "profile_vibbyRed",
  },
  {
    source: require("../assets/images/profile_vibbyGreen.png"),
    value: "profile_vibbyGreen",
  },
  {
    source: require("../assets/images/profile_vibbyPurple.png"),
    value: "profile_vibbyPurple",
  },
  {
    source: require("../assets/images/profile_vibbyBlack.png"),
    value: "profile_vibbyBlack",
  },
  {
    source: require("../assets/images/profile_vibbyYellow.png"),
    value: "profile_vibbyYellow",
  },
  {
    source: require("../assets/images/profile_vibbyGray.png"),
    value: "profile_vibbyGray",
  },
];
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      if (selectedAvatar !== null) {
        ...
        const updateResult = await updateUserData(user.id, {
          profile_picture: profilePictureValue,
        });
        if (!updateResult.success) {
          throw new Error(
            updateResult.msg || "Failed to update profile picture"
          );
        }
      } else if (
        typeof mainProfilePicture === "object" &&
        "uri" in mainProfilePicture &&
        mainProfilePicture.uri
      ) {
        ...
        const fileExtension =
          mainProfilePicture.uri.split(".").pop()?.toLowerCase() || "jpg";
      ...
      console.log(
        "🔄 User data updated with new profile picture:",
        profilePictureValue
      );
    ...
    <ScreenWrapper>
      <View style={styles.container}>
        ...
        <View style={styles.profilePictureContainer}>
          <Image source={mainProfilePicture} style={styles.profilePicture} />
          {isLoading && (
